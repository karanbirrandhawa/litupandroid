...
public class GameFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (int j = 0; i < 5; i++) {
                // Create a new linear layout as a column
                // Make gravity center

                // Add a new dotview size 45by45

                // Add onclicklistener to linearlayout that executes lightUp()
                // NOTE onclicklistner will be this (implemented by class)
            }
